					...
					<div class="center">
						...
						<div class="col-md-4  ">
							<div class="media">
								<div class="media-middle">
									<a href="testsus">
										<img class="media-object smallimg center-block" src="../img/imagesUxtest/icon-test.png" alt="test">
						...
						<div class="col-md-4  ">
							<div class="media">
								<div class="media-middle">
									<a href="">
										<img class="media-object smallimg center-block" src="../img/imagesUxtest/icon-test.png" alt="...">
